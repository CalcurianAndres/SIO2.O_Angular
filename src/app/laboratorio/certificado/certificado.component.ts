...
export class CertificadoComponent implements OnInit {
  ...
  async buildPdf(): Promise<Blob> {
    ...
    pdf.add(
      new Table([
        [
          new Cell(new Txt('SECCION A').alignment('center').bold().fontSize(9).color('#FFFFFF').end).border([false]).fillColor('#a5acb2').end,
          new Cell(new Txt('').end).border([false]).end,
          new Cell(new Txt('SECCION B').alignment('center').bold().fontSize(9).color('#FFFFFF').end).border([false]).fillColor('#a5acb2').end
        ],
        [
          new Cell(new Txt('').fontSize(5.7).end).border([false, false, false, false]).end,
          new Cell(new Txt('').end).border([false]).end,
          new Cell(new Txt('OP:').fontSize(5.7).end).border([false, false, false, false]).border([false, false, false, false]).end
        ],
        [
          new Cell(new Txt('').bold().fontSize(15).end).alignment('center').margin([0, -3, 0, -3]).border([false, false, false, false]).end,
          new Cell(new Txt('').end).border([false]).end,
          new Cell(new Txt('2026049').fontSize(15).bold().end).alignment('center').margin([0, -3, 0, -3]).border([false, false, false, true]).end
        ],
        [
          new Cell(new Txt('').fontSize(5.7).end).border([false, false, false, false]).end,
          new Cell(new Txt('').end).border([false]).end,
          new Cell(new Txt('CANTIDAD:').fontSize(5.7).end).border([false, false, false, false]).border([false, false, false, false]).end
        ],
        [
          new Cell(new Txt('').bold().fontSize(15).end).alignment('center').margin([0, -3, 0, -3]).border([false, false, false, false]).end,
          new Cell(new Txt('').end).border([false]).end,
          new Cell(new Txt('5.700').fontSize(15).bold().end).alignment('center').margin([0, -3, 0, -3]).border([false, false, false, true]).end
        ],
        [
          new Cell(new Txt('').fontSize(5.7).end).border([false, false, false, false]).end,
          new Cell(new Txt('').end).border([false]).end,
          new Cell(new Txt('FECHA DE EMISIÓN:').fontSize(5.7).end).border([false, false, false, false]).border([false, false, false, false]).end
        ],
        [
          new Cell(new Txt('CERTIFICADO DE ANÁLISIS').bold().fontSize(15).end).alignment('center').margin([0, -3, 0, -3]).border([false, false, false, true]).end,
          new Cell(new Txt('').end).border([false]).end,
          new Cell(new Txt('05/05/2026').fontSize(11).end).margin([0, -3, 0, -3]).border([false, false, false, true]).end
        ],
        [
          new Cell(new Txt('CLIENTE:').fontSize(5.7).end).border([false, false, false, false]).end,
          new Cell(new Txt('').end).border([false]).end,
          new Cell(new Txt('FECHA DE PRODUCCIÓN:').fontSize(5.7).end).border([false, false, false, false]).border([false, false, false, false]).end
        ],
        [
          new Cell(new Txt('COMPAÑIA OPERATIVA DE ALIMENTOS COR, C.A.').fontSize(11).end).margin([0, -3, 0, -3]).border([false, false, false, true]).end,
          new Cell(new Txt('').end).border([false]).end,
          new Cell(new Txt('04/05/2026').fontSize(11).end).margin([0, -3, 0, -3]).border([false, false, false, true]).end
        ],
        [
          new Cell(new Txt('PRODUCTO:').fontSize(5.7).end).border([false, false, false, false]).end,
          new Cell(new Txt('').end).border([false]).end,
          new Cell(new Txt('ORDEN DE COMPRA:').fontSize(5.7).end).border([false, false, false, false]).border([false, false, false, false]).end
        ],
        [
          new Cell(new Txt('FAMILY BOX').fontSize(11).end).margin([0, -3, 0, -3]).border([false, false, false, true]).end,
          new Cell(new Txt('').end).border([false]).end,
          new Cell(new Txt('571752').fontSize(15).bold().end).alignment('center').margin([0, -3, 0, -3]).border([false, false, false, true]).end
        ],
        [
          new Cell(new Txt('IDIOMA:').fontSize(5.7).end).border([false, false, false, false]).end,
          new Cell(new Txt('').end).border([false]).end,
          new Cell(new Txt('# DE CONTROL').fontSize(5.7).end).border([false, false, false, false]).border([false, false, false, false]).end
        ],
        [
          new Cell(new Txt('ESPAÑOL LATINO').fontSize(11).end).margin([0, -3, 0, -3]).border([false, false, false, true]).end,
          new Cell(new Txt('').end).border([false]).end,
    ...
    pdf.add(
      new Table([
        ...
        [
          new Cell(new Txt('PROPIEDADES').alignment('center').bold().fontSize(8).color('#FFFFFF').end).border([false]).fillColor(headerBg).end,
          new Cell(new Txt('REF. NORMATIVA').alignment('center').bold().fontSize(8).color('#FFFFFF').end).border([false]).fillColor(headerBg).end,
          new Cell(new Txt('ESPECIFICACIÓN (MIN - NOM - MAX)').alignment('center').bold().fontSize(8).color('#FFFFFF').end).border([false]).fillColor(headerBg).end,
          new Cell(new Txt('RESULTADOS').alignment('center').bold().fontSize(8).color('#FFFFFF').end).border([false]).fillColor(headerBg).end
        ],

        // --- SECCIÓN 1: SUSTRATO ---
        [
          new Cell(new Txt('SUSTRATO: CARTÓN REV. CREMA VITAPLUS CAL. 0,016"').bold().fontSize(8).margin([5, 2]).end).colSpan(4).fillColor(sectionBg).border([false]).end,
          {}, {}, {}
        ],
        [
        ...
        [
          ...
          new Cell(new Txt('COVENIN 26-79 / TAPPI 409').alignment('center').fontSize(7).end).fillColor(rowOdd).border([false]).end,
          new Cell(new Txt('Perpendicular a los signados principales').alignment('center').fontSize(6).end).fillColor(rowOdd).border([false]).end,
          new Cell(new Txt('CUMPLE').alignment('center').bold().fontSize(7).end).fillColor(rowOdd).border([false]).end
        ],
        [
          new Cell(new Txt('RESISTENCIA AL ÁLCALI').fontSize(7).margin([5, 1]).end).fillColor(rowEven).border([false]).end,
          new Cell(new Txt('DIN 16524-9').alignment('center').fontSize(7).end).fillColor(rowEven).border([false]).end,
          new Cell(new Txt('SIN PULPEO (NaOH 2,5% 80°C)').alignment('center').fontSize(6).end).fillColor(rowEven).border([false]).end,
          new Cell(new Txt('NO APLICA').alignment('center').fontSize(7).end).fillColor(rowEven).border([false]).end
        ],

        // --- SECCIÓN 2: COLOR ---
        [
          new Cell(new Txt('COLOR: ESTÁNDAR DE COLOR APROBADO POR EL CLIENTE').bold().fontSize(8).margin([5, 2]).end).colSpan(4).fillColor(sectionBg).border([false]).end,
          {}, {}, {}
        ],
        ...['NEGRO (K)', 'CYAN (C)', 'MAGENTA (M)', 'PANTONE 109', 'PANTONE 2035'].map((color, idx) => [
          new Cell(new Txt(color).fontSize(7).margin([20, 1]).end).fillColor(idx % 2 === 0 ? rowOdd : rowEven).border([false]).end,
          new Cell(new Txt('INSPECCIÓN VISUAL').alignment('center').fontSize(7).end).fillColor(idx % 2 === 0 ? rowOdd : rowEven).border([false]).end,
          new Cell(new Txt('ESTÁNDAR DE COLOR').alignment('center').fontSize(7).end).fillColor(idx % 2 === 0 ? rowOdd : rowEven).border([false]).end,
          new Cell(new Txt('CUMPLE').alignment('center').bold().fontSize(7).color('#27ae60').end).fillColor(idx % 2 === 0 ? rowOdd : rowEven).border([false]).end
        ]),

        // --- SECCIÓN 3: PRODUCTO TERMINADO ---
        [
          new Cell(new Txt('PRODUCTO TERMINADO').bold().fontSize(8).margin([5, 2]).end).colSpan(4).fillColor(sectionBg).border([false]).end,
          {}, {}, {}
        ],
        [
          new Cell(new Txt('DIMENSIONES (mm): ALTO').fontSize(7).margin([5, 1]).end).fillColor(rowOdd).border([false]).end,
          new Cell(new Txt('INSPECCIÓN VISUAL').alignment('center').fontSize(7).end).fillColor(rowOdd).border([false]).end,
          new Cell(new Txt('539 - 540 - 541').alignment('center').fontSize(7).end).fillColor(rowOdd).border([false]).end,
          new Cell(new Txt('540').alignment('center').bold().fontSize(8).end).fillColor(rowOdd).border([false]).end
        ],
        [
          new Cell(new Txt('DIMENSIONES (mm): LARGO').fontSize(7).margin([5, 1]).end).fillColor(rowEven).border([false]).end,
          new Cell(new Txt('INSPECCIÓN VISUAL').alignment('center').fontSize(7).end).fillColor(rowEven).border([false]).end,
          new Cell(new Txt('893 - 894 - 895').alignment('center').fontSize(7).end).fillColor(rowEven).border([false]).end,
          new Cell(new Txt('894').alignment('center').bold().fontSize(8).end).fillColor(rowEven).border([false]).end
        ],
        [
          new Cell(new Txt('RESERVA DE BARNIZ (mm)').fontSize(7).margin([5, 1]).end).fillColor(rowOdd).border([false]).end,
          new Cell(new Txt('INSPECCIÓN VISUAL').alignment('center').fontSize(7).end).fillColor(rowOdd).border([false]).end,
        ...
        [
          ...
          new Cell(new Txt('COVENIN 3382:98 / ANSI X3.182-90').alignment('center').fontSize(6).end).fillColor(rowEven).border([false]).end,
        ...
        [
          ...
          new Cell(new Txt('INSPECCIÓN VISUAL').alignment('center').fontSize(7).end).fillColor(rowEven).border([false]).end,
          new Cell(new Txt('SEGÚN ESTÁNDAR').alignment('center').fontSize(7).end).fillColor(rowEven).border([false]).end,
        ...
        [
          ...
          new Cell(new Txt('COVENIN 3133-1:2001').alignment('center').fontSize(7).end).fillColor(rowOdd).border([false]).end,
          new Cell(new Txt('NIVEL DE INSP. G1 PLAN DE MUEST. SIMPLE / INSP. NORMAL').alignment('center').fontSize(5.5).end).fillColor(rowOdd).border([false]).end,
          new Cell(new Txt('SATISFACTORIO').alignment('center').bold().fontSize(6).end).fillColor(rowOdd).border([false]).end
        ]
      ])
        .widths(['32%', '24%', '28%', '16%'])
        .layout({
