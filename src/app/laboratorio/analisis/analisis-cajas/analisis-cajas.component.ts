...
export class AnalisisCajasComponent {
  ...
  interna_larga() {
    this.analisis.longitud_interna.largo.max = Number(
      Math.max.apply(Math, this.analisis.longitud_interna.largo.largo).toFixed(2),
    );
    this.analisis.longitud_interna.largo.min = Number(
      Math.min.apply(Math, this.analisis.longitud_interna.largo.largo).toFixed(2),
    );
    ...
    this.analisis.longitud_interna.largo.desviacion = Number(
      this.desviacionEstandar(
        this.analisis.longitud_interna.largo.largo,
        this.analisis.longitud_interna.largo.promedio,
      ).toFixed(2),
    );
  ...
  interna_ancha() {
    this.analisis.longitud_interna.ancho.max = Number(
      Math.max.apply(Math, this.analisis.longitud_interna.ancho.ancho).toFixed(2),
    );
    this.analisis.longitud_interna.ancho.min = Number(
      Math.min.apply(Math, this.analisis.longitud_interna.ancho.ancho).toFixed(2),
    );
    ...
    this.analisis.longitud_interna.ancho.desviacion = Number(
      this.desviacionEstandar(
        this.analisis.longitud_interna.ancho.ancho,
        this.analisis.longitud_interna.ancho.promedio,
      ).toFixed(2),
    );
  ...
  interna_alta() {
    this.analisis.longitud_interna.alto.max = Number(
      Math.max.apply(Math, this.analisis.longitud_interna.alto.alto).toFixed(2),
    );
    this.analisis.longitud_interna.alto.min = Number(
      Math.min.apply(Math, this.analisis.longitud_interna.alto.alto).toFixed(2),
    );
    ...
    this.analisis.longitud_interna.alto.desviacion = Number(
      this.desviacionEstandar(
        this.analisis.longitud_interna.alto.alto,
        this.analisis.longitud_interna.alto.promedio,
      ).toFixed(2),
    );
  ...
  externa_larga() {
    this.analisis.longitud_externa.largo.max = Number(
      Math.max.apply(Math, this.analisis.longitud_externa.largo.largo).toFixed(2),
    );
    this.analisis.longitud_externa.largo.min = Number(
      Math.min.apply(Math, this.analisis.longitud_externa.largo.largo).toFixed(2),
    );
    ...
    this.analisis.longitud_externa.largo.desviacion = Number(
      this.desviacionEstandar(
        this.analisis.longitud_externa.largo.largo,
        this.analisis.longitud_externa.largo.promedio,
      ).toFixed(2),
    );
  ...
  externa_ancha() {
    this.analisis.longitud_externa.ancho.max = Number(
      Math.max.apply(Math, this.analisis.longitud_externa.ancho.ancho).toFixed(2),
    );
    this.analisis.longitud_externa.ancho.min = Number(
      Math.min.apply(Math, this.analisis.longitud_externa.ancho.ancho).toFixed(2),
    );
    ...
    this.analisis.longitud_externa.ancho.desviacion = Number(
      this.desviacionEstandar(
        this.analisis.longitud_externa.ancho.ancho,
        this.analisis.longitud_externa.ancho.promedio,
      ).toFixed(2),
    );
  ...
  externa_alta() {
    this.analisis.longitud_externa.alto.max = Number(
      Math.max.apply(Math, this.analisis.longitud_externa.alto.alto).toFixed(2),
    );
    this.analisis.longitud_externa.alto.min = Number(
      Math.min.apply(Math, this.analisis.longitud_externa.alto.alto).toFixed(2),
    );
    ...
    this.analisis.longitud_externa.alto.desviacion = Number(
      this.desviacionEstandar(
        this.analisis.longitud_externa.alto.alto,
        this.analisis.longitud_externa.alto.promedio,
      ).toFixed(2),
    );
  ...
  externa_espesor() {
    ...
    this.analisis.espesor.desviacion = Number(
      this.desviacionEstandar(this.analisis.espesor.espesor, this.analisis.espesor.promedio).toFixed(2),
    );
  ...
  AnalisisCompletado() {
    ...
    const maxDecimals = Math.max(
      ...analisis.longitud_interna.largo.largo.map((num) => {
    ...
    // Encontrar el número máximo de decimales
    const maxDecimals1 = Math.max(
      ...analisis.longitud_interna.ancho.ancho.map((num) => {
        const decimals = num.toString().split('.')[1];
        return decimals ? decimals.length : 0;
      }),
    );
    ...
    // Encontrar el número máximo de decimales
    const maxDecimals2 = Math.max(
      ...analisis.longitud_interna.alto.alto.map((num) => {
        const decimals = num.toString().split('.')[1];
        return decimals ? decimals.length : 0;
      }),
    );
    ...
    // Encontrar el número máximo de decimales
    const maxDecimals3 = Math.max(
      ...analisis.longitud_externa.largo.largo.map((num) => {
        const decimals = num.toString().split('.')[1];
        return decimals ? decimals.length : 0;
      }),
    );
    ...
    // Encontrar el número máximo de decimales
    const maxDecimals4 = Math.max(
      ...analisis.longitud_externa.alto.alto.map((num) => {
        const decimals = num.toString().split('.')[1];
        return decimals ? decimals.length : 0;
      }),
    );
    ...
    // Encontrar el número máximo de decimales
    const maxDecimals5 = Math.max(
      ...analisis.longitud_externa.ancho.ancho.map((num) => {
        const decimals = num.toString().split('.')[1];
        return decimals ? decimals.length : 0;
      }),
    );
    ...
    // Encontrar el número máximo de decimales
    const maxDecimals6 = Math.max(
      ...analisis.espesor.espesor.map((num) => {
        const decimals = num.toString().split('.')[1];
        return decimals ? decimals.length : 0;
      }),
    );
    ...
    li_largo_esp[0] = Material.material.especificacion2.especificacion.li_largo_min
      ...
      : 'N/A';
    li_largo_esp[1] = Material.material.especificacion2.especificacion.li_largo_nom
      ? Material.material.especificacion2.especificacion.li_largo_nom
      : 'N/A';
    li_largo_esp[2] = Material.material.especificacion2.especificacion.li_largo_max
      ? Material.material.especificacion2.especificacion.li_largo_max
      : 'N/A';

    li_ancho_esp[0] = Material.material.especificacion2.especificacion.li_ancho_min
      ? Material.material.especificacion2.especificacion.li_ancho_min
      : 'N/A';
    li_ancho_esp[1] = Material.material.especificacion2.especificacion.li_ancho_nom
      ? Material.material.especificacion2.especificacion.li_ancho_nom
      : 'N/A';
    li_ancho_esp[2] = Material.material.especificacion2.especificacion.li_ancho_max
      ? Material.material.especificacion2.especificacion.li_ancho_max
      : 'N/A';

    li_alto_esp[0] = Material.material.especificacion2.especificacion.li_alto_min
      ? Material.material.especificacion2.especificacion.li_alto_min
      : 'N/A';
    li_alto_esp[1] = Material.material.especificacion2.especificacion.li_alto_nom
      ? Material.material.especificacion2.especificacion.li_alto_nom
      : 'N/A';
    li_alto_esp[2] = Material.material.especificacion2.especificacion.li_alto_max
      ? Material.material.especificacion2.especificacion.li_alto_max
      : 'N/A';

    le_largo_esp[0] = Material.material.especificacion2.especificacion.le_largo_min
      ? Material.material.especificacion2.especificacion.le_largo_min
      : 'N/A';
    le_largo_esp[1] = Material.material.especificacion2.especificacion.le_largo_nom
      ? Material.material.especificacion2.especificacion.le_largo_nom
      : 'N/A';
    le_largo_esp[2] = Material.material.especificacion2.especificacion.le_largo_max
      ? Material.material.especificacion2.especificacion.le_largo_max
      : 'N/A';

    le_ancho_esp[0] = Material.material.especificacion2.especificacion.le_ancho_min
      ? Material.material.especificacion2.especificacion.le_ancho_min
      : 'N/A';
    le_ancho_esp[1] = Material.material.especificacion2.especificacion.le_ancho_nom
      ? Material.material.especificacion2.especificacion.le_ancho_nom
      : 'N/A';
    le_ancho_esp[2] = Material.material.especificacion2.especificacion.le_ancho_max
      ? Material.material.especificacion2.especificacion.le_ancho_max
      : 'N/A';

    le_alto_esp[0] = Material.material.especificacion2.especificacion.le_alto_min
      ? Material.material.especificacion2.especificacion.le_alto_min
      : 'N/A';
    le_alto_esp[1] = Material.material.especificacion2.especificacion.le_alto_nom
      ? Material.material.especificacion2.especificacion.le_alto_nom
      : 'N/A';
    le_alto_esp[2] = Material.material.especificacion2.especificacion.le_alto_max
      ? Material.material.especificacion2.especificacion.le_alto_max
      : 'N/A';

    espesor_esp[0] = Material.material.especificacion2.especificacion.espesor_min
      ? Material.material.especificacion2.especificacion.espesor_min
      : 'N/A';
    espesor_esp[1] = Material.material.especificacion2.especificacion.espesor_nom
      ? Material.material.especificacion2.especificacion.espesor_nom
      : 'N/A';
    espesor_esp[2] = Material.material.especificacion2.especificacion.espesor_max
    ...
    async function GenerarCertificado() {
      ...
      pdf.add(
        new Table([
          [
            new Cell(await new Img('../../assets/poli_cintillo.png').width(60).margin([0, 5]).build())
              .alignment('center')
              .rowSpan(4).end,
            new Cell(
              new Txt(`
          ...
          [
            new Cell(new Txt('').end).end,
            new Cell(new Txt('').end).end,
            new Cell(new Txt('Fecha de Revision: 18/08/2022').end).fillColor('#dedede').fontSize(5).alignment('center')
              .end,
          ],
          [
            new Cell(new Txt('').end).end,
      ...
      pdf.add(
        new Table([
          [
            new Cell(new Txt('INFORMACIÓN').bold().end)
              .fontSize(8)
              .color('#ffffff')
              .fillColor('#000000')
      ...
      pdf.add(
        new Table([
          [
            new Cell(new Txt('CARACTERÍSTICAS Y PROPIEDADES').bold().end)
              .fontSize(8)
              .color('#ffffff')
              .fillColor('#000000')
              .decorationColor('#ffffff')
      ...
      pdf.add(
        new Table([
          [
            ...
            new Cell(new Txt('LONGITUD INTERNA (cm)').end)
              .fillColor('#9b9b9b')
              .colSpan(3)
              .fontSize(7)
              .alignment('center').end,
            ...
            new Cell(new Txt('').end).fontSize(7).alignment('center').end,
            new Cell(new Txt('LONGITUD EXTERNA (cm)').end)
              .fillColor('#9b9b9b')
              .colSpan(3)
              .fontSize(7)
              .alignment('center').end,
            new Cell(new Txt('').end).fontSize(7).alignment('center').end,
            new Cell(new Txt('').end).fontSize(7).alignment('center').end,
            new Cell(new Txt('ESPESOR (mm)').end)
              .fillColor('#9b9b9b')
              .margin([0, 5.5])
              .rowSpan(2)
              .fontSize(7)
          ...
          [
            ...
            new Cell(await new Img('../../assets/promedio.gif').width(4).build())
              .alignment('center')
              .fillColor('#9b9b9b')
              .colSpan(2)
            ...
            new Cell(
              new Txt(
                analisis.longitud_interna.largo.promedio.toFixed(analisis.longitud_interna.largo.decimales),
              ).bold().end,
            )
              .fillColor('#9b9b9b')
            ...
            new Cell(
              new Txt(
                analisis.longitud_interna.ancho.promedio.toFixed(analisis.longitud_interna.ancho.decimales),
              ).bold().end,
            )
              .fillColor('#9b9b9b')
              .border([true, false, false, false])
            ...
            new Cell(
              new Txt(
                analisis.longitud_interna.alto.promedio.toFixed(analisis.longitud_interna.alto.decimales),
              ).bold().end,
            )
              .fillColor('#9b9b9b')
              .border([true, false, false, false])
            ...
            new Cell(
              new Txt(
                analisis.longitud_externa.largo.promedio.toFixed(analisis.longitud_externa.largo.decimales),
              ).bold().end,
            )
              .fillColor('#9b9b9b')
              .border([true, false, false, false])
            ...
            new Cell(
              new Txt(
                analisis.longitud_externa.ancho.promedio.toFixed(analisis.longitud_externa.ancho.decimales),
              ).bold().end,
            )
              .fillColor('#9b9b9b')
              .border([true, false, false, false])
            ...
            new Cell(
              new Txt(
                analisis.longitud_externa.alto.promedio.toFixed(analisis.longitud_externa.alto.decimales),
              ).bold().end,
            )
              .fillColor('#9b9b9b')
              .border([true, false, false, false])
              .fontSize(7)
              .alignment('center').end,
            new Cell(new Txt(analisis.espesor.promedio.toFixed(analisis.espesor.decimales)).bold().end)
              .fillColor('#9b9b9b')
          ...
          [
            new Cell(new Stack(operaciones).end)
              .border([true, false])
              .colSpan(2)
              .fontSize(7)
              .fillColor('#9b9b9b')
            ...
            new Cell(new Stack(li_largo).end).border([true, false]).fillColor('#c8c8c8').fontSize(7).alignment('center')
              .end,
            new Cell(new Stack(li_ancho).end).border([true, false]).fillColor('#c8c8c8').fontSize(7).alignment('center')
              .end,
            new Cell(new Stack(li_alto).end).border([true, false]).fillColor('#c8c8c8').fontSize(7).alignment('center')
              .end,
            new Cell(new Stack(le_largo).end).border([true, false]).fillColor('#c8c8c8').fontSize(7).alignment('center')
              .end,
            new Cell(new Stack(le_ancho).end).border([true, false]).fillColor('#c8c8c8').fontSize(7).alignment('center')
              .end,
            new Cell(new Stack(le_alto).end).border([true, false]).fillColor('#c8c8c8').fontSize(7).alignment('center')
              .end,
            new Cell(new Stack(espesor).end)
              .border([true, false, true, false])
              .fillColor('#c8c8c8')
              .fontSize(7)
              .alignment('center').end,
      ...
      pdf.add(
        new Table([
          [
            new Cell(new Txt('OBSERVACIÓN').bold().end)
              .fontSize(8)
              .color('#ffffff')
              .fillColor('#000000')
              .decorationColor('#ffffff')
            ...
            new Cell(new Txt('RESULTADO').bold().end)
              .fontSize(8)
              .color('#ffffff')
              .fillColor('#000000')
              .decorationColor('#ffffff')
