...
export class AnalisisSustratoComponent {
  ...
  gramaje(i) {
    this.analisis.gramaje.gramaje[i] =
      (this.analisis.gramaje.masa_inicial[i] / (this.analisis.ancho * this.analisis.largo)) * 10000;
    ...
    this.analisis.gramaje.desviacion = Number(
      this.desviacionEstandar(this.analisis.gramaje.gramaje, this.analisis.gramaje.promedio).toFixed(2),
    );
  ...
  cobb(i) {
    if (i + 1 <= this.analisis.numero_muestras / 2) {
      ...
      this.analisis.cobb.top.desviacion = Number(
        this.desviacionEstandar(this.analisis.cobb.top.cobb, this.analisis.cobb.top.promedio).toFixed(2),
      );
    ...
    if (i + 1 > this.analisis.numero_muestras / 2) {
      ...
      this.analisis.cobb.back.desviacion = Number(
        this.desviacionEstandar(fill, this.analisis.cobb.back.promedio).toFixed(2),
      );
  ...
  calibre_(i) {
    ...
    this.analisis.calibre.mm.desviacion = this.desviacionEstandar(
      this.analisis.calibre.mm.mm,
    ...
    this.analisis.calibre.um.desviacion = this.desviacionEstandar(
      this.analisis.calibre.um.um,
    ...
    this.analisis.calibre.pt.desviacion = this.desviacionEstandar(
      this.analisis.calibre.pt.pt,
  ...
  curling_(i) {
    this.analisis.curling_blancura.curling.max = Number(
      Math.max.apply(Math, this.analisis.curling_blancura.curling.curling).toFixed(2),
    );
    this.analisis.curling_blancura.curling.min = Number(
      Math.min.apply(Math, this.analisis.curling_blancura.curling.curling).toFixed(2),
    );
    ...
    this.analisis.curling_blancura.curling.desviacion = Number(
      this.desviacionEstandar(
        this.analisis.curling_blancura.curling.curling,
        this.analisis.curling_blancura.curling.promedio,
      ).toFixed(2),
    );
  ...
  blancura_(i) {
    this.analisis.curling_blancura.blancura.max = Number(
      Math.max.apply(Math, this.analisis.curling_blancura.blancura.blancura).toFixed(2),
    );
    this.analisis.curling_blancura.blancura.min = Number(
      Math.min.apply(Math, this.analisis.curling_blancura.blancura.blancura).toFixed(2),
    );
    ...
    this.analisis.curling_blancura.blancura.desviacion = Number(
      this.desviacionEstandar(
        this.analisis.curling_blancura.blancura.blancura,
        this.analisis.curling_blancura.blancura.promedio,
      ).toFixed(2),
    );
  ...
  escuadra_(i) {
    this.analisis.dimensiones.Escuadra.max = Number(
      Math.max.apply(Math, this.analisis.dimensiones.Escuadra.escuadra).toFixed(2),
    );
    this.analisis.dimensiones.Escuadra.min = Number(
      Math.min.apply(Math, this.analisis.dimensiones.Escuadra.escuadra).toFixed(2),
    );
    ...
    this.analisis.dimensiones.Escuadra.desviacion = Number(
      this.desviacionEstandar(
        this.analisis.dimensiones.Escuadra.escuadra,
        this.analisis.dimensiones.Escuadra.promedio,
      ).toFixed(2),
    );
  ...
  contraEscuadra_(i) {
    this.analisis.dimensiones.contraEscuadra.max = Number(
      Math.max.apply(Math, this.analisis.dimensiones.contraEscuadra.contraEscuadra).toFixed(2),
    );
    this.analisis.dimensiones.contraEscuadra.min = Number(
      Math.min.apply(Math, this.analisis.dimensiones.contraEscuadra.contraEscuadra).toFixed(2),
    );
    ...
    this.analisis.dimensiones.contraEscuadra.desviacion = Number(
      this.desviacionEstandar(
        this.analisis.dimensiones.contraEscuadra.contraEscuadra,
        this.analisis.dimensiones.contraEscuadra.promedio,
      ).toFixed(2),
    );
  ...
  Pinza_(i) {
    this.analisis.dimensiones.Pinza.max = Number(
      Math.max.apply(Math, this.analisis.dimensiones.Pinza.pinza).toFixed(2),
    );
    this.analisis.dimensiones.Pinza.min = Number(
      Math.min.apply(Math, this.analisis.dimensiones.Pinza.pinza).toFixed(2),
    );
    ...
    this.analisis.dimensiones.Pinza.desviacion = Number(
      this.desviacionEstandar(this.analisis.dimensiones.Pinza.pinza, this.analisis.dimensiones.Pinza.promedio).toFixed(
        2,
      ),
    );
  ...
  contraPinza_(i) {
    this.analisis.dimensiones.contraPinza.max = Number(
      Math.max.apply(Math, this.analisis.dimensiones.contraPinza.contraPinza).toFixed(2),
    );
    this.analisis.dimensiones.contraPinza.min = Number(
      Math.min.apply(Math, this.analisis.dimensiones.contraPinza.contraPinza).toFixed(2),
    );
    ...
    this.analisis.dimensiones.contraPinza.desviacion = Number(
      this.desviacionEstandar(
        this.analisis.dimensiones.contraPinza.contraPinza,
        this.analisis.dimensiones.contraPinza.promedio,
      ).toFixed(2),
    );
  ...
  AnalisisCompletado() {
    ...
    async function GenerarCertificado() {
      ...
      pdf.add(
        new Table([
          ...
          [
            new Cell(new Txt('').end).end,
            new Cell(new Txt('').end).end,
            new Cell(new Txt('Fecha de Revision: 28/06/2023').end).fillColor('#dedede').fontSize(5).alignment('center')
              .end,
          ],
          [
            new Cell(new Txt('').end).end,
      ...
      pdf.add(
        new Table([
          [
            new Cell(new Txt('INFORMACIÓN DE SUSTRATO').bold().end)
              .fontSize(8)
              .color('#ffffff')
              .fillColor('#000000')
      ...
      pdf.add(
        new Table([
          [
            ...
            new Cell(
              new Txt(
                `${Material.material.nombre} ${Material.material.gramaje}g (${Material.ancho}x${Material.largo})`,
              ).end,
            )
              .fontSize(6)
              .colSpan(2).end,
            ...
            new Cell(new Txt(Material.lote).alignment('center').bold().end)
              .alignment('center')
              .rowSpan(2)
              .margin([0, 3]).end,
          ],
      ...
      pdf.add(
        new Table([
          [
            new Cell(new Txt('PROPIEDADES A EVALUAR DEL SUSTRATO').bold().end)
              .fontSize(8)
              .color('#ffffff')
              .fillColor('#000000')
              .decorationColor('#ffffff')
      ...
      pdf.add(
        new Table([
          [
            new Cell(new Txt('#').alignment('center').end)
              .fontSize(6)
              .margin([0, 15])
              .rowSpan(4)
              .fillColor('#4e4e4e')
              .color('#FFFFFF').end,
            new Cell(new Txt('Gramaje').alignment('center').end)
              .fontSize(6)
              .colSpan(2)
              .fillColor('#4e4e4e')
              .color('#FFFFFF').end,
            new Cell(new Txt('Gramaje').alignment('center').end).fontSize(6).fillColor('#4e4e4e').color('#FFFFFF').end,
            new Cell(new Txt('Cobb').alignment('center').end)
              .fontSize(6)
              .colSpan(3)
              .fillColor('#4e4e4e')
              .color('#FFFFFF').end,
            ...
            new Cell(new Txt('Gramaje').alignment('center').end).fontSize(6).fillColor('#4e4e4e').color('#FFFFFF').end,
            new Cell(new Txt('Calibre').alignment('center').end)
              .fontSize(6)
              .colSpan(3)
              .fillColor('#4e4e4e')
              .color('#FFFFFF').end,
            ...
            new Cell(new Txt('').alignment('center').end).rowSpan(3).border([false, false]).fontSize(6).color('#FFFFFF')
              .end,
            new Cell(new Txt('').alignment('center').end).rowSpan(4).fontSize(6).fillColor('#4e4e4e').end,
            new Cell(new Txt('Dimensiones del pliego (mm)').alignment('center').end)
              .fillColor('#4e4e4e')
              .color('#FFFFFF')
              .colSpan(4)
              .fontSize(6).end,
          ...
          [
            new Cell(new Txt(' ').alignment('center').end).fontSize(6).fillColor('#bdbdbd').end,
            new Cell(new Txt('Masa inicial (g)').alignment('center').margin([0, 10]).end)
              .rowSpan(3)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt('Gramaje\n (g/m²)').alignment('center').end).fontSize(6).fillColor('#bdbdbd').end,
            new Cell(new Txt('Masa final (g)').alignment('center').margin([0, 10]).end)
              .rowSpan(3)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            ...
            new Cell(new Txt('').alignment('center').end).border([false, false]).fontSize(6).color('#FFFFFF').end,
            new Cell(new Txt('Escuadra').alignment('center').margin([0, 5]).end)
              .rowSpan(3)
              .fillColor('#bdbdbd')
              .fontSize(6).end,
            new Cell(new Txt('contra escuadra').alignment('center').margin([0, 5]).end)
              .rowSpan(3)
              .fillColor('#bdbdbd')
              .fontSize(6).end,
            new Cell(new Txt('Pinza').alignment('center').margin([0, 5]).end)
              .rowSpan(3)
              .fillColor('#bdbdbd')
              .fontSize(6).end,
            new Cell(new Txt('Contra pinza').alignment('center').margin([0, 5]).end)
              .rowSpan(3)
              .fillColor('#bdbdbd')
              .fontSize(6).end,
          ],
          [
            ...
            new Cell(new Txt('COVENIN 1243-78').alignment('center').end).colSpan(2).fontSize(5).fillColor('#cecece')
              .end,
            new Cell(new Txt('-').alignment('center').end).fontSize(6).fillColor('#bdbdbd').end,
          ...
          [
            ...
            new Cell(new Stack(analisis.gramaje.masa_final).fontSize(6).alignment('center').end)
              .rowSpan(2)
              .fillColor('#dedede').end,
            new Cell(new Stack(analisis.cobb.top.cobb).end)
              .rowSpan(2)
              .fontSize(6)
              .alignment('center')
              .fillColor('#dedede').end,
            new Cell(new Stack(analisis.cobb.back.cobb).end)
              .rowSpan(2)
              .fontSize(6)
              .alignment('center')
              .fillColor('#dedede').end,
            ...
            new Cell(new Stack(analisis.curling_blancura.curling.curling).end)
              .rowSpan(2)
              .fontSize(6)
              .alignment('center')
              .fillColor('#dedede').end,
            new Cell(new Stack(analisis.curling_blancura.blancura.blancura).end)
              .rowSpan(2)
              .fontSize(6)
              .alignment('center').end,
            new Cell(new Txt('').alignment('center').end).rowSpan(2).border([false, false]).fontSize(6).color('#FFFFFF')
              .end,
            new Cell(new Stack(muestras_).alignment('center').end).rowSpan(2).fontSize(6).end,
            new Cell(new Stack(analisis.dimensiones.Escuadra.escuadra).alignment('center').end).rowSpan(2).fontSize(6)
              .end,
            new Cell(new Stack(analisis.dimensiones.contraEscuadra.contraEscuadra).alignment('center').end)
              .rowSpan(2)
              .fontSize(6).end,
            new Cell(new Stack(analisis.dimensiones.Pinza.pinza).alignment('center').end).rowSpan(2).fontSize(6).end,
            new Cell(new Stack(analisis.dimensiones.contraPinza.contraPinza).alignment('center').end)
              .rowSpan(2)
              .fontSize(6).end,
          ],
          [
      ...
      pdf.add(
        new Table([
          [
            new Cell(new Txt('X̅').alignment('center').bold().end)
              .border([true, false, true, true])
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt('n/a').alignment('center').end)
              .border([true, false, true, true])
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt(analisis.gramaje.promedio.toFixed(analisis.gramaje.decimales)).alignment('center').end)
              .border([true, false, true, true])
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt('n/a').alignment('center').end)
              ...
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt(`${analisis.cobb.top.promedio.toString()}`).alignment('center').end)
              .border([true, false, true, true])
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt(`${analisis.cobb.back.promedio.toString()}`).alignment('center').end)
              .border([true, false, true, true])
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(
              new Txt(analisis.calibre.mm.promedio.toFixed(analisis.calibre.mm.decimales)).alignment('center').end,
            )
              .border([true, false, true, true])
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(
              new Txt(analisis.calibre.um.promedio.toFixed(analisis.calibre.um.decimales)).alignment('center').end,
            )
              .border([true, false, true, true])
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(
              new Txt(analisis.calibre.pt.promedio.toFixed(analisis.calibre.pt.decimales)).alignment('center').end,
            )
              .border([true, false, true, true])
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(
              new Txt(
                analisis.curling_blancura.curling.promedio.toFixed(analisis.curling_blancura.curling.deciameles),
              ).alignment('center').end,
            )
              .border([true, false, true, true])
              .fontSize(6)
            ...
            new Cell(
              new Txt(
                analisis.curling_blancura.blancura.promedio.toFixed(analisis.curling_blancura.blancura.decimales),
              ).alignment('center').end,
            )
              .border([true, false, true, true])
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt('').alignment('center').end).border([false, false]).fontSize(6).end,
            new Cell(new Txt('X̅').alignment('center').end)
              .border([true, false, true, true])
              .fillColor('#bdbdbd')
              .fontSize(6).end,
            new Cell(
              new Txt(
                analisis.dimensiones.Escuadra.promedio.toFixed(analisis.dimensiones.Escuadra.decimales),
              ).alignment('center').end,
            )
              .border([true, false, true, true])
              .fontSize(6)
            ...
            new Cell(
              new Txt(
                analisis.dimensiones.contraEscuadra.promedio.toFixed(analisis.dimensiones.contraEscuadra.decimales),
              ).alignment('center').end,
            )
              .border([true, false, true, true])
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(
              new Txt(analisis.dimensiones.Pinza.promedio.toFixed(analisis.dimensiones.Pinza.decimales)).alignment(
                'center',
              ).end,
            )
              .colSpan(2)
            ...
            new Cell(
              new Txt(
                analisis.dimensiones.contraPinza.promedio.toFixed(analisis.dimensiones.contraPinza.deciameles),
              ).alignment('center').end,
            )
              .colSpan(2)
              .border([true, false, true, true])
          ...
          [
            new Cell(new Txt('S').alignment('center').bold().end)
              .border([true, false, true, true])
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt('n/a').alignment('center').end).fontSize(6).fillColor('#bdbdbd').end,
            new Cell(new Txt(analisis.gramaje.desviacion.toFixed(analisis.gramaje.decimales)).alignment('center').end)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt('n/a').alignment('center').end).fontSize(6).fillColor('#bdbdbd').end,
            new Cell(new Txt(`${analisis.cobb.top.desviacion.toString()}`).alignment('center').end)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt(`${analisis.cobb.back.desviacion.toString()}`).alignment('center').end)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(
              new Txt(analisis.calibre.mm.desviacion.toFixed(analisis.calibre.mm.decimales)).alignment('center').end,
            )
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(
              new Txt(analisis.calibre.um.desviacion.toFixed(analisis.calibre.um.decimales)).alignment('center').end,
            )
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(
              new Txt(analisis.calibre.pt.desviacion.toFixed(analisis.calibre.pt.decimales)).alignment('center').end,
            )
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(
              new Txt(
                analisis.curling_blancura.curling.desviacion.toFixed(analisis.curling_blancura.curling.deciameles),
              ).alignment('center').end,
            )
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(
              new Txt(
                analisis.curling_blancura.blancura.desviacion.toFixed(analisis.curling_blancura.blancura.deciameles),
              ).alignment('center').end,
            )
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            ...
            new Cell(
              new Txt(
                analisis.dimensiones.Escuadra.desviacion.toFixed(analisis.dimensiones.Escuadra.decimales),
              ).alignment('center').end,
            )
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(
              new Txt(
                analisis.dimensiones.contraEscuadra.desviacion.toFixed(analisis.dimensiones.contraEscuadra.decimales),
              ).alignment('center').end,
            )
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(
              new Txt(analisis.dimensiones.Pinza.desviacion.toFixed(analisis.dimensiones.Pinza.decimales)).alignment(
                'center',
              ).end,
            )
              .colSpan(2)
            ...
            new Cell(
              new Txt(
                analisis.dimensiones.contraPinza.desviacion.toFixed(analisis.dimensiones.contraPinza.decimales),
              ).alignment('center').end,
            )
              .colSpan(2)
              .fontSize(6)
          ...
          [
            new Cell(new Txt('mín').alignment('center').bold().end)
              .border([true, false, true, true])
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt('n').alignment('center').end).fontSize(6).fillColor('#bdbdbd').end,
            new Cell(new Txt(analisis.gramaje.min.toString()).alignment('center').end).fontSize(6).fillColor('#bdbdbd')
              .end,
            new Cell(new Txt('n').alignment('center').end).fontSize(6).fillColor('#bdbdbd').end,
            ...
            new Cell(new Txt(analisis.calibre.mm.min.toString()).alignment('center').end)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt(analisis.calibre.um.min.toString()).alignment('center').end)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt(analisis.calibre.pt.min.toString()).alignment('center').end)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt(analisis.curling_blancura.curling.min.toString()).alignment('center').end)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt(analisis.curling_blancura.blancura.min.toString()).alignment('center').end)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt('').alignment('center').end).border([false, false]).fontSize(6).end,
            new Cell(new Txt('mín').alignment('center').end).fillColor('#bdbdbd').fontSize(6).end,
            new Cell(new Txt(analisis.dimensiones.Escuadra.min.toString()).alignment('center').end)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt(analisis.dimensiones.contraEscuadra.min.toString()).alignment('center').end)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt(analisis.dimensiones.Pinza.min.toString()).alignment('center').end)
              .colSpan(2)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt('').alignment('center').end).fontSize(6).fillColor('#eeeded').end,
            new Cell(new Txt(analisis.dimensiones.contraPinza.min.toString()).alignment('center').end)
              .colSpan(2)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt('').alignment('center').end).fontSize(6).fillColor('#eeeded').end,
          ...
          [
            new Cell(new Txt('máx').alignment('center').bold().end)
              .border([true, false, true, true])
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt('n').alignment('center').end).fontSize(6).fillColor('#bdbdbd').end,
            new Cell(new Txt(analisis.gramaje.max.toString()).alignment('center').end).fontSize(6).fillColor('#bdbdbd')
              .end,
            new Cell(new Txt('n').alignment('center').end).fontSize(6).fillColor('#bdbdbd').end,
            ...
            new Cell(new Txt(analisis.calibre.mm.max.toString()).alignment('center').end)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt(analisis.calibre.um.max.toString()).alignment('center').end)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt(analisis.calibre.pt.max.toString()).alignment('center').end)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt(analisis.curling_blancura.curling.max.toString()).alignment('center').end)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt(analisis.curling_blancura.blancura.max.toString()).alignment('center').end)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt('').alignment('center').end).border([false, false]).fontSize(6).end,
            new Cell(new Txt('máx').alignment('center').end).fillColor('#bdbdbd').fontSize(6).end,
            new Cell(new Txt(analisis.dimensiones.Escuadra.max.toString()).alignment('center').end)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt(analisis.dimensiones.contraEscuadra.max.toString()).alignment('center').end)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt(analisis.dimensiones.Pinza.max.toString()).alignment('center').end)
              .colSpan(2)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt('').alignment('center').end).fontSize(6).fillColor('#eeeded').end,
            new Cell(new Txt(analisis.dimensiones.contraPinza.max.toString()).alignment('center').end)
              .colSpan(2)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
          ...
          [
            new Cell(new Txt('ESPEC.').alignment('center').bold().margin([0, 10]).end)
              .border([true, false, true, true])
              .rowSpan(3)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt('mín').alignment('center').bold().end).fontSize(6).fillColor('#eeeded').end,
            new Cell(new Txt(Material.material.especificacion.gramaje.min).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt('n/a').alignment('center').end).fontSize(6).fillColor('#eeeded').end,
            new Cell(new Txt(Material.material.especificacion.cobb.top.min).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt(Material.material.especificacion.cobb.back.min).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt(Material.material.especificacion.calibre.mm.min).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt(Material.material.especificacion.calibre.um.min).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt(Material.material.especificacion.calibre.pt.min).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt(Material.material.especificacion.curling.min).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt(Material.material.especificacion.blancura.min).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt('').alignment('center').end).border([false, false]).fontSize(6).end,
            ...
            new Cell(new Txt(Material.material.ancho).alignment('center').end).fontSize(6).fillColor('#bdbdbd').end,
            new Cell(new Txt(Material.material.largo).alignment('center').end)
              .colSpan(2)
              .fontSize(6)
              .fillColor('#bdbdbd').end,
            new Cell(new Txt('').alignment('center').end).fontSize(6).fillColor('#eeeded').end,
          ...
          [
            ...
            new Cell(new Txt(Material.material.especificacion.gramaje.nom).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt('n/a').alignment('center').end).fontSize(6).fillColor('#eeeded').end,
            new Cell(new Txt(Material.material.especificacion.cobb.top.nom).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt(Material.material.especificacion.cobb.back.nom).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt(Material.material.especificacion.calibre.mm.nom).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt(Material.material.especificacion.calibre.um.nom).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt(Material.material.especificacion.calibre.pt.nom).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt(Material.material.especificacion.curling.nom).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt(Material.material.especificacion.blancura.nom).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt('').alignment('center').end).border([false, false]).fontSize(6).end,
            new Cell(new Txt('').alignment('center').end).border([false, false]).fontSize(6).color('#FFFFFF').end,
          ...
          [
            ...
            new Cell(new Txt(Material.material.especificacion.gramaje.max).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt('n/a').alignment('center').end).fontSize(6).fillColor('#eeeded').end,
            new Cell(new Txt(Material.material.especificacion.cobb.top.max).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt(Material.material.especificacion.cobb.back.max).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt(Material.material.especificacion.calibre.mm.max).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt(Material.material.especificacion.calibre.um.max).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt(Material.material.especificacion.calibre.pt.max).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt(Material.material.especificacion.curling.max).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt(Material.material.especificacion.blancura.max).alignment('center').end)
              .fontSize(6)
              .fillColor('#eeeded').end,
            new Cell(new Txt('').alignment('center').end).border([false, false]).fontSize(6).end,
            new Cell(new Txt('').alignment('center').end).border([false, false]).fontSize(6).color('#FFFFFF').end,
      ...
      pdf.add(
        new Table([
          [
            new Cell(new Txt('OBSERVACIÓN').fontSize(8).alignment('center').end).fillColor('#000000').color('#FFFFFF')
              .end,
            new Cell(new Txt('RESULTADO DE ANÁLISIS').fontSize(8).alignment('center').end)
              .fillColor('#0000000')
              .color('#FFFFFF').end,
          ],
          [
            new Cell(new Txt(analisis.resultado.observacion).fontSize(8).end).rowSpan(2).end,
            new Cell(new Txt(analisis.resultado.resultado).fontSize(10).bold().end).border([false]).alignment('center')
              .end,
          ],
          [
            ...
            new Cell(
              new Table([
                [
                  new Cell(new Txt('Realizado por:').fontSize(8).alignment('center').end)
                    .colSpan(2)
                    .fillColor('#000000')
                    .color('#FFFFFF').end,
                  new Cell(new Txt('Realizado por:').fontSize(8).alignment('center').end)
                  ...
                  new Cell(new Txt('Validado por:').fontSize(8).alignment('center').end)
                    .colSpan(2)
                    .fillColor('#0000000')
                    .color('#FFFFFF').end,
                  new Cell(new Txt('Validado por:').fontSize(8).alignment('center').end)
