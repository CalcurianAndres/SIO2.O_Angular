...
export class AnalisisPadsComponent {
  ...
  largo() {
    ...
    this.analisis.largo.desviacion = Number(
      this.desviacionEstandar(this.analisis.largo.largo, this.analisis.largo.promedio).toFixed(2),
    );
  ...
  ancho() {
    ...
    this.analisis.ancho.desviacion = Number(
      this.desviacionEstandar(this.analisis.ancho.ancho, this.analisis.ancho.promedio).toFixed(2),
    );
  ...
  signado() {
    ...
    this.analisis.signado.desviacion = Number(
      this.desviacionEstandar(this.analisis.signado.signado, this.analisis.signado.promedio).toFixed(2),
    );
  ...
  AnalisisCompletado = async () => {
    ...
    let _analisis_largo_largo = analisis.largo.largo.map((num) => num.toFixed(maxDecimals).replace('.', ','));
    ...
    // Rellenar con ceros los números para que todos tengan el mismo número de decimales y cambiar puntos por comas
    let _analisis_ancho_ancho = analisis.ancho.ancho.map((num) => num.toFixed(maxDecimals2).replace('.', ','));
    ...
    const maxDecimals3 = Math.max(
      ...analisis.signado.signado.map((num) => {
        const decimals = num.toString().split('.')[1];
        return decimals ? decimals.length : 0;
      }),
    );
    ...
    // Rellenar con ceros los números para que todos tengan el mismo número de decimales y cambiar puntos por comas
    let _analisis_signado_signado = analisis.signado.signado.map((num) => num.toFixed(maxDecimals3).replace('.', ','));
    ...
    // Rellenar con ceros los números para que todos tengan el mismo número de decimales y cambiar puntos por comas
    let _analisis_espesor_espesor = analisis.espesor.espesor.map((num) => num.toFixed(maxDecimals4).replace('.', ','));
      ...
      pdf.add(
        new Table([
          ...
          [
            new Cell(new Txt('').end).end,
            new Cell(new Txt('').end).end,
            new Cell(new Txt('Fecha de Revision: 09/06/2023').end).fillColor('#dedede').fontSize(5).alignment('center')
              .end,
          ],
          [
            new Cell(new Txt('').end).end,
      ...
      pdf.add(
        new Table([
          ...
          [
            ...
            new Cell(new Txt(promedio_largo).bold().end)
              .fillColor('#9b9b9b')
              .border([true, false, false, false])
              .fontSize(7)
              .alignment('center').end,
            new Cell(new Txt(promedio_ancho).bold().end)
              .fillColor('#9b9b9b')
              .border([true, false, false, false])
              .fontSize(7)
              .alignment('center').end,
            new Cell(new Txt(promedio_signado).bold().end)
              .fillColor('#9b9b9b')
              .border([true, false, false, false])
              .fontSize(7)
              .alignment('center').end,
            new Cell(new Txt(promedio_espesor).bold().end)
              .fillColor('#9b9b9b')
          ...
          [
            ...
            new Cell(new Stack(largo_analisis).end)
              .border([true, false])
              .fillColor('#c8c8c8')
              .fontSize(7)
              .alignment('center').end,
            new Cell(new Stack(ancho_analisis).end)
              .border([true, false])
              .fillColor('#c8c8c8')
              .fontSize(7)
              .alignment('center').end,
            new Cell(new Stack(signado_analisis).end)
              .border([true, false])
              .fillColor('#c8c8c8')
              .fontSize(7)
              .alignment('center').end,
            new Cell(new Stack(espesor_analisis).end)
              .border([true, false, true, false])
              .fillColor('#c8c8c8')
              .fontSize(7)
              .alignment('center').end,
