...
export class AnalisisOtrosComponent {
  ...
  getThirdKeyValue(): { key: string; value: any } {
    if (
      ...
      const filteredKeys = keys.filter((key) => !['_id', 'apariencia', 'ph_m', 'ph_M'].includes(key));
  ...
  AnalisisCompletado() {
    ...
    const agrupados = recepcion.materiales[0].reduce(
      (acc, material) => {
    ...
    async function GenerarCertificado() {
      ...
      pdf.add(
        new Table([
          ...
          [
            new Cell(new Txt('').end).end,
            new Cell(new Txt('').end).end,
            new Cell(new Txt('Fecha de Revision: 01/08/2022').end).fillColor('#dedede').fontSize(5).alignment('center')
              .end,
          ],
          [
            new Cell(new Txt('').end).end,
      ...
      pdf.add(
        new Table([
          [
            new Cell(new Txt('INFORMACIÓN DEL INSUMO/OTRO').bold().end)
              .fontSize(8)
              .color('#ffffff')
              .fillColor('#000000')
      ...
      pdf.add(
        new Table([
          ...
          [
            new Cell(new Txt('PROVEEDOR').end).color('#ffffff').fillColor('#3b3b3b').alignment('center').fontSize(9)
              .end,
            new Cell(new Txt(recepcion.proveedor.nombre).end).alignment('center').fontSize(9).end,
          ],
          [
            new Cell(new Txt('PRESENTACIÓN').end).color('#ffffff').fillColor('#3b3b3b').alignment('center').fontSize(9)
              .end,
          ...
          [
            new Cell(new Txt('FECHA DE FABRICACIÓN').end)
              .color('#ffffff')
              .fillColor('#3b3b3b')
              .alignment('center')
              .fontSize(9).end,
          ...
          [
            new Cell(new Txt('FECHA DE VENCIMIENTO').end)
              .color('#ffffff')
              .fillColor('#3b3b3b')
              .alignment('center')
              .fontSize(9).end,
          ...
          [
            new Cell(new Txt('FECHA DE RECEPCIÓN').end)
              .color('#ffffff')
              .fillColor('#3b3b3b')
              .alignment('center')
              .fontSize(9).end,
          ...
          [
            new Cell(new Txt('Nº DE LOTE').end).color('#ffffff').fillColor('#3b3b3b').alignment('center').fontSize(9)
              .end,
      ...
      pdf.add(
        new Table([
          [
            new Cell(new Txt('ANÁLISIS CUALITATIVO').bold().end)
              .border([false])
              .fontSize(8)
              .color('#ffffff')
              .fillColor('#8b8b8b')
      ...
      pdf.add(
        new Table([
          [
            new Cell(new Txt('ANÁLISIS CUANTITATIVO').bold().end)
              .border([false])
              .fontSize(8)
              .color('#ffffff')
              .fillColor('#8b8b8b')
      ...
      pdf.add(
        new Table([
          [
            new Cell(new Txt('pH').end).alignment('center').margin([0, 5]).fillColor('#c4c4c4').rowSpan(2).fontSize(8)
              .end,
          ...
          [
            ...
            new Cell(
              new Txt(
                `${Material.material.especificacion2.especificacion.ph_m} - ${Material.material.especificacion2.especificacion.ph_M}`,
              ).end,
            )
              .alignment('center')
              .fontSize(8).end,
      ...
      if (key.length > 0) {
        pdf.add(
          new Table([
            [
              new Cell(new Txt('PRUEBAS O ENSAYOS ADICIONALES').bold().end)
                .fontSize(8)
                .color('#ffffff')
                .fillColor('#000000')
                .decorationColor('#ffffff')
        ...
        pdf.add(
          new Table([
            [
              new Cell(new Txt(key).end).alignment('center').margin([0, 5]).fillColor('#c4c4c4').rowSpan(2).fontSize(8)
                .end,
              new Cell(new Txt('ESPECIFICACIÓN').end).alignment('center').fillColor('#c4c4c4').fontSize(8).end,
              new Cell(new Txt('RESULTADO').end).alignment('center').fillColor('#c4c4c4').fontSize(8).end,
            ],
