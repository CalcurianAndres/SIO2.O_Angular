...
export class UsuariosComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.login.buscarUsuario().subscribe((resp: any) => {
      this.usuarios = resp;
    });
  }
  ...
  crearUsuario() {
    ...
    this.login.registrar(data).subscribe((resp: any) => {
  ...
  cambiarRol(e, usuario) {
    ...
    this.login.editarUsuario(usuario).subscribe((resp: any) => {
      console.log(resp);
    });
  }
  ...
  eliminarUsuario(usuario, i) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.login.eliminarUsuario(usuario._id).subscribe((resp: any) => {
