...
export const PAISES: Pais[] = ([
  ...
  { nombre: 'República Democrática del Congo', nombreEn: 'Democratic Republic of the Congo', cca2: 'CD', prefijo: '+243' },
  ...
  { nombre: 'San Vicente y las Granadinas', nombreEn: 'Saint Vincent and the Grenadines', cca2: 'VC', prefijo: '+1784' },
...
] as Pais[]).map(p => ({ ...p, bandera: getFlagUrl(p.cca2) }));
