...
export class SolicitudesComponent implements OnInit{
  ...
  generarSolicitud() {
    ...
    if (this.orden_solicitud.sustrato.cantidad > 0) {
      data.materiales.push({ material: this.orden_solicitud.sustrato.id, cantidad: this.orden_solicitud.sustrato.cantidad });
    }
    ...
    if (this.orden_solicitud.barniz.cantidad > 0) {
      data.materiales.push({ material: this.orden_solicitud.barniz.id, cantidad: this.orden_solicitud.barniz.cantidad });
    }
