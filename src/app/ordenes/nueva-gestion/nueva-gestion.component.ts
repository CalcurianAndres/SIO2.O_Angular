...
export class NuevaGestionComponent {
  ...
  filteredEmployees_() {
    ...
    return this.trabajadores.trabajador.filter(trabajador => {
      const nombreCompleto = `${trabajador.datos_personales.nombres} ${trabajador.datos_personales.apellidos}`;
      const searchMatch = trabajador.datos_personales.nombres.toLowerCase().includes(this.searchText_.toLowerCase()) ||
  ...
  filteredEmployees__() {
    ...
    return this.trabajadores.trabajador.filter(trabajador => {
      const nombreCompleto = `${trabajador.datos_personales.nombres} ${trabajador.datos_personales.apellidos}`;
      const searchMatch = trabajador.datos_personales.nombres.toLowerCase().includes(this.searchText__.toLowerCase()) ||
  ...
  filteredEmployees___() {
    ...
    return this.trabajadores.trabajador.filter(trabajador => {
      const nombreCompleto = `${trabajador.datos_personales.nombres} ${trabajador.datos_personales.apellidos}`;
      const searchMatch = trabajador.datos_personales.nombres.toLowerCase().includes(this.searchText___.toLowerCase()) ||
  ...
  filteredEmployees____() {
    ...
    return this.trabajadores.trabajador.filter(trabajador => {
      const nombreCompleto = `${trabajador.datos_personales.nombres} ${trabajador.datos_personales.apellidos}`;
      const searchMatch = trabajador.datos_personales.nombres.toLowerCase().includes(this.searchText____.toLowerCase()) ||
  ...
  buscarDefectos(){
    this.defectos_ = this.defectos.buscarPorClienteYCategoria(this.orden.cliente._id, this.orden.producto[0].identificacion.categoria).defectos
