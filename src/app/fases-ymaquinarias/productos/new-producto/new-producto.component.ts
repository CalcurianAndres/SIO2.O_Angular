...
export class NewProductoComponent {
  ...
  subirImagen(e, n) {
    ...
    this.uploadImage.actualizarFoto(image, 'producto', tipo).then((img) => {
      switch (n) {
        case 0:
  ...
  Impresion_(maquina, fase_) {
    let incluye;
    if (fase_ === 'Otro') {
      incluye = maquina.fases.some(
        (fase) =>
          fase.nombre != 'Impresión' &&
          fase.nombre != 'Impresion 2 pase' &&
          fase.nombre != 'Barnizar' &&
          fase.nombre != 'Troquelado' &&
          fase.nombre != 'Cortado' &&
          fase.nombre != 'Pegado',
      );
    } else {
    ...
    async function generarPDF() {
      ...
      pdf.add(
        new Table([
          ...
          [
            new Cell(
              await new Img('https://192.168.0.22/api/imagen/producto/PRODUCTO_2_4_2024_15_42_39_494.png')
                .width(450)
                .margin([0, 15])
                .build(),
            )
              ...
              new Table([
                [
                  ...
                  new Cell(
                    new Table([
                      [
                        new Cell(new Txt(Carton[i].ubicacion[n].especificacion.calibre[c][0].toString()).end)
                          .border([false])
                          .alignment('center').end,
                        new Cell(new Txt(Carton[i].ubicacion[n].especificacion.calibre[c][1].toString()).end)
                          .border([false])
                          .alignment('center').end,
                        new Cell(new Txt(Carton[i].ubicacion[n].especificacion.calibre[c][2].toString()).end)
                          .border([false])
                          .alignment('center').end,
                      ],
                    ]).widths(['33.3%', '33.3%', '33.3%']).end,
                  ...
                  new Cell(
                    new Table([
                      [
                        new Cell(new Txt(Carton[i].ubicacion[n].especificacion.gramaje[c][0].toString()).end)
                          .border([false])
                          .alignment('center').end,
                        new Cell(new Txt(Carton[i].ubicacion[n].especificacion.gramaje[c][1].toString()).end)
                          .border([false])
                          .alignment('center').end,
                        new Cell(new Txt(Carton[i].ubicacion[n].especificacion.gramaje[c][2].toString()).end)
                          .border([false])
                          .alignment('center').end,
                      ],
                    ]).widths(['33.3%', '33.3%', '33.3%']).end,
      ...
      for (let i = 0; i < Colores.length; i++) {
        if (Colores[i].preparacion) {
          pdf.add(
            new Table([
              [
                new Cell(new Txt(Colores[i].color).end)
      ...
      pdf.add(
        new Table([
          ...
          [new Cell(new Columns([new Txt('M-AH-001-1-A').end, new Txt('M-AH-001-1-B').end]).end).border([false]).end],
          [
          ...
          [
            new Cell(
              new Columns([new Txt('M-AH-001-1-A_14062023.ai').end, new Txt('M-AH-001-1-B_28062023.ai').end]).end,
            ).border([false]).end,
          ],
          [
          ...
          [new Cell(new Columns([new Ul(PeliculasA).end, new Ul(PeliculasB).end]).end).border([false]).end],
          ...
          [new Cell(new Columns([new Txt('95 x 70 cm').end, new Txt('64 x 93 cm').end]).end).border([false]).end],
          [new Cell(new Columns([new Txt('18 Ejemplares').end, new Txt('16 Ejemplares').end]).end).border([false]).end],
          [
          ...
          [
            new Cell(
              new Columns([new Txt('1.5cm x 1cm x 1cm x 1cm').end, new Txt('1.5cm x 1cm x 1cm x 1cm').end]).end,
            ).border([false]).end,
          ],
          [
          ...
          [new Cell(new Columns([new Txt('6262').end, new Txt('5452.1').end]).end).border([false]).end],
          [
          ...
          [new Cell(new Columns([new Txt('6.20').end, new Txt('9.17').end]).end).border([false]).end],
      ...
      pdf.add(
        new Table([
          ...
          [new Cell(new Txt(' ').end).border([false]).fontSize(1).end],
          [
            new Cell(new Txt('5.1 Impresora(s) aprobada(s) - (tamaño de pinza de impresión (mm))').end)
              .fillColor('#dedede')
              .bold()
              .border([false, false, false, false]).end,
          ],
          ...
          [
            new Cell(new Txt('5.2 Secuencia de colores en máquina').end)
              .fillColor('#dedede')
              .bold()
              .border([false, false, false, false]).end,
          ],
          [new Cell(new Columns([new Txt(impresoras_[0]).end, new Txt(impresoras_[1]).end]).end).border([false]).end],
          [
            new Cell(
              new Columns([
          ...
          [
            new Cell(new Txt('5.3 Solución de fuentes').end)
              .fillColor('#dedede')
              .bold()
              .border([false, false, false, false]).end,
          ],
          ...
          [new Cell(new Txt(' ').end).border([false]).fontSize(1).end],
          [
            new Cell(new Txt('6.1 Troqueladora(s) aprobada(s)').end)
              .fillColor('#dedede')
              .bold()
              .border([false, false, false, false]).end,
          ],
          ...
          [
            new Cell(new Txt('6.2 Canal de hendidura').end)
              .fillColor('#dedede')
              .bold()
              .border([false, false, false, false]).end,
          ],
          ...
          [
            new Cell(new Txt('6.3 Guillotina(s) aprobada(s)').end)
              .fillColor('#dedede')
              .bold()
              .border([false, false, false, false]).end,
          ],
          ...
          [
            new Cell(new Txt('6.4 Pegadora(s) aprobada(s)').end)
              .fillColor('#dedede')
              .bold()
              .border([false, false, false, false]).end,
          ],
          [new Cell(new Ul(['No aplica']).end).border([false]).end],
          [
            new Cell(new Txt('6.5 Pegamento(s) aprobado(s)').end)
              .fillColor('#dedede')
              .bold()
              .border([false, false, false, false]).end,
          ],
          [
            new Cell(new Ul(['Pega Alta Viscocidad 104 HV 15P', 'Pega Alta Viscocidad 104 HV 15P']).end).border([false])
              .end,
          ],
        ]).widths(['100%']).end,
      );
      ...
      pdf.add(
        new Table([
          [
            new Cell(new Txt('6.6 Cajas de embalaje').end)
              .fillColor('#dedede')
              .bold()
              .border([false, false, false, false]).end,
          ],
      ...
      pdf.add(
        new Table([
          [
            new Cell(new Txt('6.7 Distribucion del producto').end)
              .fillColor('#dedede')
              .bold()
              .border([false, false, false, false]).end,
          ],
          [
            new Cell(new Columns([new Txt('Vista aerea').end, new Txt('Vista 3D').end]).end)
              .fillColor('#f1f1f1')
              .border([false]).end,
          ],
        ]).widths(['100%']).end,
        ...
        new Table([
          [
            new Cell(
              new Columns([
                new Cell(
                  await new Img('https://192.168.0.23:8080/api/imagen/aereo/62266c741c1b1805b8ad24a0-434.png')
                    .width(250)
                    .margin([0, 15])
                    .build(),
                )
                  ...
                  .border([false]).end,
                new Cell(
                  await new Img('https://192.168.0.23:8080/api/imagen/distribucion/62266c741c1b1805b8ad24a0-478.png')
                    .width(250)
                    .margin([0, 15])
                    .build(),
                )
      ...
      pdf.add(
        new Table([
          [
            new Cell(new Txt('Peso de caja (kg)').end).fillColor('#f1f1f1').bold().border([false, false, false, false])
              .end,
            new Cell(new Txt('Cantidad de estibas').end)
              .fillColor('#f1f1f1')
              .bold()
              .border([false, false, false, false]).end,
          ],
          [new Cell(new Txt('20').end).border([false]).end, new Cell(new Txt('5').end).border([false]).end],
        ]).widths(['50%', '50%']).end,
      );
      ...
      pdf.add(
        new Table([
          [
            new Cell(new Txt('Peletizado aprobado').end)
              .fillColor('#f1f1f1')
              .bold()
              .border([false, false, false, false]).end,
          ],
          [
            new Cell(
              await new Img('https://192.168.0.23:8080/api/imagen/despacho/62266c741c1b1805b8ad24a0-959.png')
                .width(250)
                .margin([0, 15])
                .build(),
            )
      ...
      pdf.add(
        new Table([
          [
            new Cell(new Txt('7. Clasificación de defectos').bold().end).bold().color('#FFFFFF').fillColor('#000000')
              .end,
          ],
          [new Cell(new Txt(' ').end).border([false]).fontSize(1).end],
          [
            new Cell(new Txt('7.1 Defectos críticos AQL 1,5%').bold().end).bold().fillColor('#f1f1f1').border([false])
              .end,
          ],
          [
            new Cell(
              new Ul([
                ...
                'Rayas',
                'Cartón roto, maltratado, fuera de norma',
                'Arqueado',
                'Despegado lateral',
                'Litografía borrosa',
                'Mal corte y/o desperdicios en el estuche',
              ]).end,
            ).border([false]).end,
          ],
          [
            new Cell(new Txt('7.1 Defectos máyores AQL 1,5%').bold().end).bold().fillColor('#f1f1f1').border([false])
              .end,
          ],
          [
            new Cell(
          ...
          [
            new Cell(new Txt('7.1 Defectos menores AQL 1,5%').bold().end).bold().fillColor('#f1f1f1').border([false])
              .end,
          ],
          [
            new Cell(
      ...
      pdf.add(
        new Table([
          [new Cell(new Txt(' ').end).border([false]).fontSize(1).end],
          [
            new Cell(new Txt('8. Preparación colores pantone usados').bold().end)
              .bold()
              .color('#FFFFFF')
