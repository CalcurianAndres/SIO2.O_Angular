...
export class ProductosComponent implements OnInit {
  ...
  Producto: Producto_ = {
    ...
    pre_impresion: {
      ...
      tamano_sustrato: {
        ...
        margenes: [
          { inferior: '0', superior: '0', izquierdo: '0', derecho: '0' },
          { inferior: '0', superior: '0', izquierdo: '0', derecho: '0' },
        ],
      },
      plancha: {
  ...
  DescargarPDF(producto: any) {
    let defecto_ = this.defects.buscarPorClienteYCategoria(
    ...
    async function generarEspecificacion() {
      ...
      if (producto.pre_impresion.montajes === '2') {
        ...
        pdf.add(
          new Table([
            ...
            [new Cell(new Columns([new Ul(peliculas).end, new Ul([]).end]).end).border([false]).end],
      ...
      pdf.add(
        new Table([
          ...
          [new Cell(new Columns([new Txt('').end, new Txt('').end]).end).border([false]).end],
          [
            new Cell(
              new Columns([
          ...
          [
            new Cell(
              new Txt(`${producto.post_impresion.henidura.alto} x ${producto.post_impresion.henidura.ancho} mm`).end,
            ).border([false]).end,
          ],
          [
          ...
          [
            new Cell(
              new Columns([
                new Cell(
                  await new Img(
                    `https://192.168.0.22/api/imagen/producto/${producto.post_impresion.distribucion.aerea}`,
                  )
                    .width(250)
                    .margin([0, 15])
                    .build(),
                  ...
                  .border([false]).end,
                new Cell(
                  await new Img(`https://192.168.0.22/api/imagen/producto/${producto.post_impresion.distribucion.v3d}`)
                    .width(250)
                    .margin([0, 15])
                    .build(),
                )
      ...
      pdf.add(
        new Table([
          ...
          [
            new Cell(
              await new Img(
                `https://192.168.0.22/api/imagen/producto/${producto.post_impresion.distribucion.paletizado}`,
              )
                .width(250)
                .margin([0, 15])
                .build(),
      ...
      pdf.add(
        new Table([
          ...
          [new Cell(new Txt(' ').end).border([false]).fontSize(1).end],
          [
            new Cell(new Txt(`7.1 Defectos menores AQL ${defecto_.defectos.menores.aql}%`).bold().end)
              .bold()
              .fillColor('#f1f1f1')
              .border([false]).end,
          ],
          ...
          [
            new Cell(new Txt(`7.2 Defectos máyores AQL ${defecto_.defectos.mayores.aql}%`).bold().end)
              .bold()
              .fillColor('#f1f1f1')
              .border([false]).end,
          ],
          ...
          [
            new Cell(new Txt(`7.2 Defectos crítios AQL ${defecto_.defectos.criticos.aql}%`).bold().end)
              .bold()
              .fillColor('#f1f1f1')
              .border([false]).end,
          ],
  ...
  Cambios() {
    const producto = {
      ...
      impresion: {
        ...
        secuencia: [
          ['Amarillo', 'Negro', '233', 'Cyan'],
          ['233', 'Negro', 'Cyan', 'Amarillo'],
        ],
        pinzas: [[], ['']],
        fuentes: [
          {
